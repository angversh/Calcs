...
#include <limits>
#include "Inf.cpp"
#include "NewCacls.cpp"

using namespace std;

class MyStack : public MyList {  //стек и односв. список
public:
	MyStack() {
		HeadNode = NULL;
	}
...
class MyQueue : public MyList {   // очередь и односв. список
public:
	MyQueue() {
		HeadNode = NULL;
	}
...
public:
	double res, ans;
	int ErrCode; //0 - No error, 1 - Operation overflow, 2 - Division by Zero
